...
class _BookingScreenState extends State<FourTable> {
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text('4-Seat Table', style: Theme.of(context).textTheme.headline6),
                      ...
                      () {
                        if (_numberOfSeats < 4) {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                              content: Text(
                                  "Maximum of 4 seats can be booked on this table."),
