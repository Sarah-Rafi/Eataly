...
class bookingRewardsScreen extends StatelessWidget {
  const bookingRewardsScreen({super.key});
          ...
          child: Column(
            children: <Widget>[
              ...
              Padding(
                ...
                child: Center(
                  child: Image.asset(
                      'assets/images/image3.png'), // Your gift image asset path
                ),
              ),
              const Padding(
              ...
              ElevatedButton(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    Text(
                      'Redeem Booking Rewards', // Replace with your button text
                      style: TextStyle(
