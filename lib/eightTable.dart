...
class EightTable extends StatefulWidget {
  @override
  _BookingScreenState createState() => _BookingScreenState();
}

class _BookingScreenState extends State<EightTable> {
  int _numberOfSeats = 8;
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text('8-Seat Table', style: Theme.of(context).textTheme.headline6),
                      ...
                      () {
                        if (_numberOfSeats < 8) {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                              content:
                                  Text("Maximum of 8 seats can be booked."),
